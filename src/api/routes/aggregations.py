...
async def aggregate_zip_data(
    ...
    min_density: float | None = Query(None, ge=0, description="Optional ZIP-row density floor in people/km² (filters ZIPs before grouping)"),
    max_density: float | None = Query(None, ge=0, description="Optional ZIP-row density ceiling in people/km² (filters ZIPs before grouping)"),
